...
const pretty_names = {
    ...
    'action-resize-1'  : 'Global change grid size',
    'action-resize-2'  : 'Global resize left',
    'action-resize-3'  : 'Global resize right',
    'action-resize-4'  : 'Global resize up',
    'action-resize-5'  : 'Global resize down',
    'action-resize-6'  : 'Global move left',
    'action-resize-7'  : 'Global move right',
    'action-resize-8'  : 'Global move up',
    'action-resize-9'  : 'Global move down',
